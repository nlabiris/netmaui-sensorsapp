...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MauiApp1.Services.SensorsService, MauiApp1", SensorsService.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == SensorsService.class)
			mono.android.TypeManager.Activate ("MauiApp1.Services.SensorsService, MauiApp1", "", this, new java.lang.Object[] {  });
	}
